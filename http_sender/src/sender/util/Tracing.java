...
/**
* A util class to configure Jaeger Tracer
* @author Liming Liu
*/
public final class Tracing {
    ...
    public static JaegerTracer init(String service) {
        ...
        reporterConfig.getSenderConfiguration().withAgentHost(System.getenv("JAGER_HOST")).withAgentPort(Integer.parseInt(System.getenv("JAGER_PORT")));
